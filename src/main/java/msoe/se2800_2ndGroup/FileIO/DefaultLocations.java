...
public class DefaultLocations {
     ...
     * <p>
     * Sources:
     * <a href="#{@link}">{@link "https://stackoverflow.com/a/44241904"}</a>: Help finding the
    ...
    public static String getDefaultCurriculumLocation() {
        return (Objects.requireNonNull(Model.class.getResource("curriculum.csv"))).toString()
                .replace("file:/", "");
    }
    ...
    public static String getDefaultOfferingsLocation() {
        return (Objects.requireNonNull(Model.class.getResource("offerings.csv"))).toString()
                .replace("file:/", "");
    }
    ...
    public static String getDefaultPrerequisitesLocation() {
        return (Objects.requireNonNull(Model.class.getResource("prerequisites_updated.csv")))
