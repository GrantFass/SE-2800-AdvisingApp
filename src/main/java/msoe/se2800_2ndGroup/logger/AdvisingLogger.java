...
public class AdvisingLogger {
     ...
     * <p>
     * Sources:
     * <a href="#{@link}">{@link "https://examples.javacodegeeks
     * .com/core-java/util/logging/java-util-logging-example/"}</a>: Help setting up the logger
     * defaults
     * <a href="#{@link}">{@link "https://www.journaldev.com/977/logger-in-java-logging-example"}
     * </a>: Help adding a custom formatter for fileHandler
     * <a href="#{@link}">{@link "https://stackoverflow.com/a/2533250"}</a>: Stop echoing to
     * console twice
     *
     * @author : Grant Fass
