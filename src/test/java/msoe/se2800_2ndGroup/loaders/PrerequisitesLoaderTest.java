...
public class PrerequisitesLoaderTest {
    ...
    public static Collection<Object[]> data() throws IOException {
        ...
        return Arrays.asList(new Object[][] {
                ...
                { "NESTED5", new Course("NESTED5", 5, new AndPrerequisite(new SinglePrerequisite("TEST1"), new AndPrerequisite(new OrPrerequisite(new SinglePrerequisite("TEST2"), new SinglePrerequisite("TEST3")), new SinglePrerequisite("TEST4"))), "Testing single-and-or-and-single nesting") },
                ...
                { "NESTED7", new Course("NESTED7", 5, new OrPrerequisite(new OrPrerequisite(new SinglePrerequisite("TEST1"), new SinglePrerequisite("TEST2")), new OrPrerequisite(new SinglePrerequisite("TEST3"), new SinglePrerequisite("TEST4"))), "Testing or-or-or nesting") },
